...
class BidCY(Bid):
    ...
    def __init__(self, debug=True):
        ...
        self.exit_counts = 0
        self.file_name = '广州国企阳光采购服务平台-城轨采购网公告'
        self.parse_dict = parse_dict.get(self.file_name)

    def run(self, keyword):
        TIMEOUT = 60
        self.keyword = keyword
        url = 'http://cg.gemas.com.cn/cgcgwgg/index{}.jhtml'
    ...
    def list_parse(self, content, url):
        ...
        html = etree.HTML(content)
        url_list = html.xpath("//li[@class='clearfix']/a/@href")
        for item in url_list:
            if self.exit_flag:
                return
            detail_url = urljoin(url, item)
            # detail_url = 'http://cg.gemas.com.cn/cgjggs/22111.jhtml'
            try:
