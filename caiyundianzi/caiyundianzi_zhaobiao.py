...
class BidCY(Bid):
    ...
    def __init__(self):
        ...
        self.exit_counts = 0
        self.file_name = '彩云电子招标采购平台-招标公告'
        self.parse_dict = parse_dict.get(self.file_name)

    def run(self, keyword):
        TIMEOUT = 60
        self.keyword = keyword
        url = 'https://www.caiyunzhaobiao.com/ytcms/category/bulletinList.html?searchDate=1996-12-23&dates=300&categoryId=2&tabName=%E6%8B%9B%E6%A0%87%E5%85%AC%E5%91%8A&industryName=&status=&tendertype=&tenderMethod=&page={}&word={}'
