...
class BidCY(Bid):
    ...
    def run(self, keyword):
        ...
        url = 'https://ec.ceec.net.cn/HomeInfo/ProjectList.aspx?InfoLevel=MQA=&bigType=WgBCAEcARwA=&smallType=aAB3AA==&PageD={}'
    ...
    def list_parse(self, content, url):
        ...
        for item in url_list:
            ...
            # detail_url = 'https://ec.ceec.net.cn/HomeInfo/winDidDetails.aspx?threadID=830d7ff4-dae6-4848-8b3d-a170f2d00137'
            try:
