...
class BidCY(Bid):
    ...
    def run(self, keyword):
        ...
        url_dict = {
            "货物采购": "https://ec.ceec.net.cn/HomeInfo/ProjectList.aspx?InfoLevel=MgA=&bigType=WgBCAEcAUwA=&smallType=aAB3AA==&PageD={}",
            "工程分包": "https://ec.ceec.net.cn/HomeInfo/ProjectList.aspx?InfoLevel=MgA=&bigType=WgBCAEcAUwA=&smallType=ZwBjAA==&PageD={}",
            "服务采购": "https://ec.ceec.net.cn/HomeInfo/ProjectList.aspx?InfoLevel=MgA=&bigType=WgBCAEcAUwA=&smallType=ZgB3AA==&PageD={}",
        }
    ...
    def list_parse(self, content, url):
        ...
        for item in url_list:
            ...
            # detail_url = 'https://ec.ceec.net.cn/HomeInfo/winDidDetails.aspx?threadID=1537bbf0-b232-47fb-add1-a527a9108179'
            try:
