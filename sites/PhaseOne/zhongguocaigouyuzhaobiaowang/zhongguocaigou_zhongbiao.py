...
class BidZG(Bid):
    ...
    def run(self, keyword):
        ...
        url = 'http://www.e-bidding.org/cms/category/bulletinList.html?dates=300&categoryId=90&tabName=%E4%B8%AD%E6%A0%87%E5%85%AC%E7%A4%BA&page={}&word={}'
    ...
    def list_parse(self, content, url):
        ...
        for item in url_list:
            ...
            detail_url = item
            # detail_url = 'http://www.e-bidding.org/resultBulletin/2017-07-13/13900.html'
            list_headers = {
                'accept': 'text/html,application/xhtml+xml,application/xml;q=0.9,image/avif,image/webp,image/apng,*/*;q=0.8,application/signed-exchange;v=b3;q=0.9',
                'accept-encoding': 'gzip, deflate',
                'accept-language': 'zh-CN,zh;q=0.9',
