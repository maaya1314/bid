...
class BidZG(Bid):
    ...
    def run(self, keyword):
        ...
        url = 'http://www.e-bidding.org/cms/category/bulletinList.html?dates=300&categoryId=89&tabName=%E5%8F%98%E6%9B%B4%E5%85%AC%E5%91%8A&page={}&word={}'
    ...
    def list_parse(self, content, url):
        ...
        for item in url_list:
            ...
            detail_url = item
            # detail_url = 'http://www.e-bidding.org/changeBulletin/2020-06-22/29651.html'
            list_headers = {
                'accept': 'text/html,application/xhtml+xml,application/xml;q=0.9,image/avif,image/webp,image/apng,*/*;q=0.8,application/signed-exchange;v=b3;q=0.9',
                'accept-encoding': 'gzip, deflate',
                'accept-language': 'zh-CN,zh;q=0.9',
