...
class BidYG(Bid):
    ...
    def run(self, keyword):
        ...
        url = 'http://gegb2b.gdydb2b.com/TenderInfo/TenderInfoList.aspx?TiType=1'
    ...
    def list_parse(self, content, url):
        html = etree.HTML(content)
        url_list = html.xpath("//table[@id='ctl00_ContentPlaceHolder1_gvTenderInfo']//tr/td[2]/a/@href")
        ...
        for item in url_list:
            ...
            detail_url = "http://gegb2b.gdydb2b.com/TenderInfo/{}".format(item)
            list_headers = {
                'accept': 'text/html,application/xhtml+xml,application/xml;q=0.9,image/avif,image/webp,image/apng,*/*;q=0.8,application/signed-exchange;v=b3;q=0.9',
                'accept-encoding': 'gzip, deflate',
                'accept-language': 'zh-CN,zh;q=0.9',
    ...
    def fix_data(self, data, detail_content):
        ...
        if attachment_url:
            attachment_url = "http://gegb2b.gdydb2b.com/" + attachment_url.replace("../", "")
