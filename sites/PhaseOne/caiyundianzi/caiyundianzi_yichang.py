...
class BidCY(Bid):
    ...
    def __init__(self, debug=True):
        ...
        self.exit_counts = 0
        self.file_name = '彩云电子招标采购平台-异常公告'
        self.parse_dict = parse_dict.get(self.file_name)

    def run(self, keyword):
        TIMEOUT = 60
        self.keyword = keyword
        url = 'https://www.caiyunzhaobiao.com/ytcms/category/bulletinList.html?searchDate=1996-12-23&dates=300&categoryId=5&tabName=终止公告&industryName=&status=&tendertype=&tenderMethod=&page={}&word={}'
        ...
        if not content:
            ...
            return
        # parsing home page
        if "没有检索到数据" in content:
            self.log.info("no data {}".format(keyword))
            return
