...
class BidGJKF(Bid3):
    ...
    def __init__(self, debug=True):
        ...
        self.exit_counts = 0
        self.file_name = '国家开发投资公司电子采购平台-非招标采购公告'
        self.parse_dict = parse_dict.get(self.file_name)

    def run(self, keyword):
        TIMEOUT = 60
        self.keyword = keyword
        url = 'https://www.sdicc.com.cn/cgxx/ggList?caiGouType=1'
        self.headers = {
    ...
    def list_parse(self, content, url):
        ...
        for item in items:
            ...
            detail_url = 'https://www.sdicc.com.cn/cgxx/ggDetail?gcGuid={}&ggGuid={}'.format(href_2, href)
            # detail_url = 'https://www.sdicc.com.cn/cgxx/ggDetail?gcGuid=cc748582-29d3-47f2-9525-998eef4cf140&ggGuid=da26e517-1dac-4778-ad0c-65dce0993c1a'
            headers = {
