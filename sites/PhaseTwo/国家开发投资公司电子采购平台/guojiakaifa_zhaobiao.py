...
class BidGJKF(Bid3):
    ...
    def __init__(self, debug=True):
        ...
        self.exit_counts = 0
        self.file_name = '国家开发投资公司电子采购平台-招标（预审）公告'
    ...
    def list_parse(self, content, url):
        ...
        for item in items:
            ...
            detail_url = 'https://www.sdicc.com.cn/cgxx/ggDetail?gcGuid={}&ggGuid={}'.format(
                href_2, href)
            # detail_url = 'https://www.sdicc.com.cn/cgxx/ggDetail?gcGuid=eaeb2dfe-1f13-4dc6-9b17-7832751b7a73&ggGuid=b0f1a5d2-46ca-4019-a728-1dddfe5e934e'
            headers = {
