...
class BidGJKF(Bid3):
    ...
    def __init__(self, debug=True):
        ...
        self.exit_counts = 0
        self.file_name = '国家开发投资公司电子采购平台-候选人公示'
        self.parse_dict = parse_dict.get(self.file_name)

    def run(self, keyword):
        TIMEOUT = 60
        self.keyword = keyword
        url = 'https://www.sdicc.com.cn/cgxx/zbhxrList'
        self.headers = {
    ...
    def list_parse(self, content, url):
        ...
        for item in items:
            ...
            detail_url = 'https://www.sdicc.com.cn/cgxx/zbhxrDetail?bdGuid={}&guid={}'.format(href, href_2)
            # detail_url = 'https://www.sdicc.com.cn/cgxx/zbhxrDetail?bdGuid=8704db8e-37b6-474d-9525-fc297aec78f0&guid=13d003e2-4a1d-4796-9ae6-494b28a38b01'
            headers = {
            ...
            data['publish_time'] = item.xpath("string(./td[5])").replace("\n", "").replace("\r", "").replace("\t", "")
            data['tender_unit'] = item.xpath("string(./td[3])").replace("\n", "").replace("\r", "").replace("\t", "")
