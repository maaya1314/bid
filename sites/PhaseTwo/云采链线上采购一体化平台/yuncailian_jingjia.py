...
class BidCY(Bid3):
    ...
    def __init__(self, debug=True):
        ...
        self.exit_counts = 0
        self.file_name = '云采链线上采购一体化平台-竞价公告'
    ...
    def run(self, keyword):
        ...
        confirm.click()
        url_base = 'https://siteserver.choicelink.cn/api/LjSiteServer/GetRKSiteServerList?pageSize=30&offset={}&query=SiteId%3D%274795%27+AND+ChannelId+IN(%275138%27,%275140%27,%275139%27,%275141%27)+AND+title+LIKE+%27%25{}%25%27'
    ...
    def list_parse(self, content, url):
        ...
        # url_list = re.findall("toGetContent\('(.*?)'\)", content)
            ...
            done_fields = ["tender_unit", "bid_finish_time", "bid_end_time", 'tender_price']
