...
class BidHK(Bid3):
    ...
    def __init__(self, debug=True):
        ...
        self.exit_counts = 0
        self.file_name = '航空工业电子采购平台-中标公示'
        self.parse_dict = parse_dict.get(self.file_name)

    def run(self, keyword):
        TIMEOUT = 60
        self.keyword = keyword
        url_base = 'https://ebid.eavic.com/cms/channel/ywgg3/index.htm?pageNo={}'
        self.headers = {
    ...
    def list_parse(self, content, url):
        ...
        for item in items:
            ...
            detail_url = 'https://ebid.eavic.com/cms/channel/ywgg3hw/89493.htm'
