...
class BidHK(Bid3):
    def __init__(self, debug=True):
        ...
        self.exit_counts = 0
        self.file_name = '航空工业电子采购平台-中标结果公告'
        self.parse_dict = parse_dict.get(self.file_name)

    def run(self, keyword):
        TIMEOUT = 60
        self.keyword = keyword
        url_base = 'https://ebid.eavic.com/cms/channel/ywgg4/index.htm?pageNo={}'
        self.headers = {
        ...
        # pages = re.findall("1/(\d+)页", content)[0]
    ...
    def list_parse(self, content, url):
        ...
        html = etree.HTML(content)
        items = html.xpath("//ul[@id='list1']/li")
        ...
        for item in items:
            ...
            # detail_url = 'https://ebid.eavic.com/cms/channel/ywgg1hw/89020.htm'
            headers = {
            ...
            if not detail_content:
                ...
                continue
            data = {}
            data['project_title'] = item.xpath("string(./a/span[1])").replace("\ue638", "").replace("\r", "").replace(" ", "")
            data['publish_time'] = item.xpath("string(./a/em)")
