...
class BidSZSZF(Bid3):
    ...
    def __init__(self, debug=True):
        ...
        self.exit_counts = 0
        self.file_name = '深圳市政府采网-更正公告'
        self.parse_dict = parse_dict.get(self.file_name)

    def run(self, keyword):
        TIMEOUT = 60
        self.keyword = keyword
        url_base = 'http://zfcg.szggzy.com:8081/gsgg/002001/002001002/002001002002/{}.html'
        self.headers = {
    ...
    def list_parse(self, content, url):
        ...
        for item in items:
            ...
            # detail_url = 'http://zfcg.szggzy.com:8081/gsgg/002001/002001002/002001002002/20220427/82532fe7-198f-45c6-bbd7-679161ca1670.html'
            headers = {
