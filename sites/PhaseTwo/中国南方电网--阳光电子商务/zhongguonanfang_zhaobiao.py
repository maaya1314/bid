...
class BidZGNF(Bid3):
    ...
    def __init__(self, debug=True):
        ...
        self.exit_counts = 0
        self.file_name = '中国南方电网--阳光电子商务-招标公告'
        self.parse_dict = parse_dict.get(self.file_name)

    def run(self, keyword):
        TIMEOUT = 60
        self.keyword = keyword
        url_base = 'http://www.bidding.csg.cn/dbsearch.jspx?pageNo={}&channelId=52&q={}&org=&types='
        self.headers = {
    ...
    def list_parse(self, content, url):
        ...
        for item in items:
            ...
            # detail_url = 'http://www.bidding.csg.cn/zbgg/1200210957.jhtml'
            headers = {
