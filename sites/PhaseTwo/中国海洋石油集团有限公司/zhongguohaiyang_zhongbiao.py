...
class BidZGHY(Bid3):
    def __init__(self, debug=True):
        ...
        self.exit_counts = 0
        self.file_name = '中国海洋石油集团有限公司-中标公示'
        self.parse_dict = parse_dict.get(self.file_name)

    def run(self, keyword):
        TIMEOUT = 60
        self.keyword = keyword
        url_base = 'https://buy.cnooc.com.cn/cbjywebframe/services/PortalsWebservice/getMoreInfoCateList?response=application/json&callback=&pageIndex={}&pageSize=12&siteguid=&catenum=001002&title={}'
    ...
    def list_parse(self, content, url):
        ...
        for item in items:
            ...
            # detail_url = 'https://buy.cnooc.com.cn/cbjyweb/001/001002/20200820/644dbe74-2395-44e9-bef1-bf6051db6f88.html'
            headers = {
