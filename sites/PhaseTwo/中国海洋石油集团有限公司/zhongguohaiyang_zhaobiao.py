...
class BidZGHY(Bid3):
    def __init__(self, debug=True):
        ...
        self.exit_counts = 0
        self.file_name = '中国海洋石油集团有限公司-招标公告'
        self.parse_dict = parse_dict.get(self.file_name)

    def run(self, keyword):
        TIMEOUT = 60
        self.keyword = keyword
        url_base = 'https://buy.cnooc.com.cn/cbjywebframe/services/PortalsWebservice/getMoreInfoCateList?response=application/json&callback=&pageIndex={}&pageSize=12&siteguid=&catenum=001001&title={}'
    ...
    def list_parse(self, content, url):
        ...
        for item in items:
            ...
            # detail_url = 'https://buy.cnooc.com.cn/cbjyweb/001/001001/20220506/c52d9204-eff7-4072-b6ed-a31e734830ce.html'
            headers = {
