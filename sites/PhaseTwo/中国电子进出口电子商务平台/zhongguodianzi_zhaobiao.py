...
class BidZGDZ(Bid3):
    ...
    def __init__(self, debug=True):
        ...
        self.exit_counts = 0
        self.file_name = '中国电子进出口电子商务平台-招标公告'
        self.parse_dict = parse_dict.get(self.file_name)

    def run(self, keyword):
        TIMEOUT = 60
        self.keyword = keyword
        url_base = 'https://www.cec-ec.com.cn/cms/channel/1xmgg1/index.htm?pageNo={}'
        self.headers = {
    ...
    def list_parse(self, content, url):
        ...
        for item in items:
            ...
            # detail_url = 'https://www.cec-ec.com.cn/cms/channel/1xmgg1/1113.htm'
            headers = {
