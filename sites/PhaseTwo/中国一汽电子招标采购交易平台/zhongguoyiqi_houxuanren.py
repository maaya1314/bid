...
class BidGT(Bid3):
    ...
    def __init__(self, debug=True):
        ...
        self.exit_counts = 0
        self.file_name = '中国一汽电子招标采购交易平台-中标候选人公示'
        self.parse_dict = parse_dict.get(self.file_name)

    def run(self, keyword):
        TIMEOUT = 60
        self.keyword = keyword
        url = 'https://etp.faw.cn/gg/zbhxrList?zbLeiXing=1&xmLeiXing=&ggStartTimeEnd=&gongGaoType=7&isNew=1'
        self.js_str = """
    ...
    def list_parse(self, content, url):
        ...
        for item in items:
            ...
            detail_url = 'https://etp.faw.cn/gg/zbhxrDetail?guid={}&statusCode={}&isNew=1'.format(href_2, href)
            # detail_url = urljoin(url, '/staticPage/' + href)
            # detail_url = 'https://etp.faw.cn/gg/zbhxrDetail?guid=2f9397f4-1a06-43df-84d8-066a2f95444c&statusCode=2&isNew=1'
            ...
            data['agency'] = '长春一汽国际招标有限公司'
            # data['bid_end_time'] = item.get("deadline")
            done_fields = ['tender_unit', 'project_number', 'agency']
