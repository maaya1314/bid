...
class BidGT(Bid3):
    ...
    def __init__(self, debug=True):
        ...
        self.exit_counts = 0
        self.file_name = '中国一汽电子招标采购交易平台-招标/预审公告'
        self.parse_dict = parse_dict.get(self.file_name)

    def run(self, keyword):
        TIMEOUT = 60
        self.keyword = keyword
        url = 'https://etp.faw.cn/gg/ggList?zbLeiXing=1&xmLeiXing=&ggStartTimeEnd=&gongGaoType=5&isNew=1'
        self.js_str = """
    ...
    def list_parse(self, content, url):
        ...
        for item in items:
            ...
            # detail_url = 'https://etp.faw.cn/gg/ggDetail?guid={}&statusCode={}&isNew=1'.format(href_2, href)
            ...
            detail_url = 'https://etp.faw.cn/gg/ggDetail?guid={}&statusCode={}&isNew=1'.format(href_2, encrypt_str)
            # detail_url = 'https://etp.faw.cn/gg/ggDetail?guid=7930c93c-cbea-404c-8956-2dfbe927321e&statusCode=aHR0cHM6Ly9ldHAuZmF3LmNuOjQ0My9nZy9nZ0RldGFpbAr1e2p3l4r1e2p3l4+*+&isNew=1'
            headers = {
