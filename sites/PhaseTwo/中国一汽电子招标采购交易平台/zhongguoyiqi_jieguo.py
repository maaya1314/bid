...
class BidGT(Bid3):
    ...
    def __init__(self, debug=True):
        ...
        self.exit_counts = 0
        self.file_name = '中国一汽电子招标采购交易平台-中标结果公告'
        self.parse_dict = parse_dict.get(self.file_name)

    def run(self, keyword):
        TIMEOUT = 60
        self.keyword = keyword
        url = 'https://etp.faw.cn/gg/zbjgList?zbLeiXing=1&xmLeiXing=&ggStartTimeEnd=&gongGaoType=15&isNew=1'
        self.js_str = """
    ...
    def list_parse(self, content, url):
        ...
        for item in items:
            ...
            href = re.findall("\((.*?),", href_str)[0].replace("'", "")
            ...
            encrypt_str = ctx1.call(href_type, href, href_2)
            guid = ctx1.call('encodeSixF', href)
            detail_url = 'https://etp.faw.cn/gg/zbjgDetail?guid={}&statusCode=1&isNew=1'.format(guid)
