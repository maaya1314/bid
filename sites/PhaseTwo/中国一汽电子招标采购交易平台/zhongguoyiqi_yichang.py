...
class BidGT(Bid3):
    ...
    def __init__(self, debug=True):
        ...
        self.exit_counts = 0
        self.file_name = '中国一汽电子招标采购交易平台-异常公告'
        self.parse_dict = parse_dict.get(self.file_name)

    def run(self, keyword):
        TIMEOUT = 60
        self.keyword = keyword
        url = 'https://etp.faw.cn/gg/zbycList?zbLeiXing=1&xmLeiXing=&ggStartTimeEnd=&gongGaoType=16&isNew=1'
        self.js_str = """
    ...
    def list_parse(self, content, url):
        ...
        for item in items:
            ...
            detail_url = 'https://etp.faw.cn/gg/zbycDetail?guid={}&statusCode={}&isNew=1'.format(href_2, href)
            ...
            encrypt_str = ctx1.call(href_type, href_2)
            # detail_url = 'https://etp.faw.cn/gg/zbycDetail?guid={}&statusCode={}&isNew=1'.format(encrypt_str, href)
            # detail_url = detail_url.replace("+", "%2B")
            detail_url = 'https://etp.faw.cn/gg/zbycDetail?guid={}&statusCode={}&isNew=1'.format(href_2, encrypt_str)
            headers = {
            ...
            data['tender_unit'] = item.xpath("string(./div/div[last()]/div[@class='zl-desc-item'])")
