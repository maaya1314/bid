...
class BidJX(Bid3):
    ...
    def run(self, keyword):
        ...
        page = 1
        payload = {
            "condition": {"areaScope": "", "classifyType": "", "collegeIds": [], "noticeType": "", "noticeTypes": ["1"],
                          "tenderType": ""},
            "current": page,
            "size": 10
        }
    ...
    def list_parse(self, content, url):
        ...
        for item in items:
            ...
            payload = {
                "noticeId": item_id,
                # 'noticeId': '4e68be1f3e4144d8893fc8092531be63'
            }
            try:
            ...
            done_fields = ['bid_end_time', 'tender_unit']
