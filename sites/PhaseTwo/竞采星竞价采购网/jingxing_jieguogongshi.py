...
class BidJX(Bid3):
    ...
    def run(self, keyword):
        ...
        page = 1
        payload = {
            "condition": {"areaScope": "", "classifyType": "", "collegeIds": [], "noticeType": "", "noticeTypes": ["6"],
                          "tenderType": ""},
            "current": page,
            "size": 10
        }
    ...
    def list_parse(self, content, url):
        ...
        for item in items:
            ...
            payload = {
                "noticeId": item_id,
                # "noticeId": "0955ea71a73347ffabc302f1aabbe10d"
            }
            try:
            ...
            data['win_bid_announcement_time'] = detail_item.get("startTime")
            # data['bid_end_time'] = detail_item.get("endTime")
            detail_url = "https://www.easyjcx.com/#/integration/detail/{}".format(item_id)
            done_fields = ['tender_unit', 'win_bid_announcement_time']
            self.detail_parse(detail_content, detail_url, data, done_fields)
