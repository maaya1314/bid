...
class BidGT(Bid3):
    ...
    def __init__(self, debug=True):
        ...
        self.exit_counts = 0
        self.file_name = '国投电子采购平台-结果公告'
        self.parse_dict = parse_dict.get(self.file_name)

    def run(self, keyword):
        TIMEOUT = 60
        self.keyword = keyword
        url = 'https://www.sdicc.com.cn/cgxx/zbjgList'
    ...
    def list_parse(self, content, url):
        ...
        for item in items:
            ...
            detail_url = 'https://www.sdicc.com.cn/cgxx/zbjgDetail?bdGuid={}&guid={}'.format(href, href_2)
            # detail_url = urljoin(url, '/staticPage/' + href)
            # detail_url = 'https://www.sdicc.com.cn/cgxx/zbjgDetail?bdGuid=1af48a15-c4f7-40ed-95a6-3ea149fc2080&guid=36f4979d-25f7-481c-85d3-8ff8aee5794a'
