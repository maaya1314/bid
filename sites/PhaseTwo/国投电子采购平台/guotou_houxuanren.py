...
class BidGT(Bid3):
    ...
    def list_parse(self, content, url):
        ...
        for item in items:
            ...
            # detail_url = 'https://www.sdicc.com.cn/cgxx/zbhxrDetail?bdGuid=1a20ce99-77b7-4ce7-a43e-ef5a8ea35980&guid=4d41a053-5c50-4443-8fde-14fb2a67c5ad'
            headers = {
