...
parse_dict = {
    ...
    "城轨采购网-招标与采购": {
        ...
        "content": {
            "re": ["", ""],
            "xpath": ["//div[@class='base-item']/div|//div[@class='tab-content']/div[@id='noticeContent']", ""]
        },  # 正文
        "bid_finish_time": {
            "re": ["开标时间：(.+?)</p>", ""],
            "xpath": [
                "//td[@class='title'][contains(text(),'投标开始时间')]/following-sibling::td[1]",
                "//td[@class='title'][contains(text(),'开标时间')]/following-sibling::td[1]",
                # "//td[@class='title'][contains(text(),'公示开始时间')]/following-sibling::td[1]",
                      ]
        },  # 开标时间
        "bid_end_time": {
            "re": ["", ""],
            "xpath": [
                "//td[@class='title'][contains(text(),'报名截止时间')]/following-sibling::td[1]",
                "//td[@class='title'][contains(text(),'报名结束时间')]/following-sibling::td[1]",
        ...
        "bid_winner": {
            ...
            "xpath": [
                'string(//td[contains(string(), "单位名称")]/following::*[1])',
                "//td[contains(string(), '中标单位')]/../following::*[1]/td[count(//table[1]//td[contains(string(), '中标单位')]/preceding-sibling::td) + 1]",
                "//td[contains(string(), '第一中选候选人')]/../following::*[1]/td[count(//table[1]//td[contains(string(), '第一中选候选人')]/preceding-sibling::td) + 1]",
                "//span[@lang][contains(text(),'中价候选人名称')]/..", "//span[@lang][contains(text(),'候选人名称')]/..",
            ]
        },  # 中标人
        "win_bid_price": {
            "re": [
            ...
            "xpath": [
                "//td[contains(string(), '中标价')]/../following::*[1]/td[count(//table[1]//td[contains(string(), '中标价')]/preceding-sibling::td) + 1]",
                'string(//td[contains(string(), "评选价（元）")]/following::*[1])',
                '//td[contains(string(), "响应金额（元）")]/following::*[1]',
                "//span[@lang][contains(text(),'中价金额')]/..", ""
            ]
        },  # 中标金额
        "win_bid_announcement_time": {
            "re": ["", ""],
            "xpath": [
                '//p[contains(string(), "中标通知书发放时间：")]',
                "//td[@class='title'][contains(text(),'公示结束时间')]/following-sibling::td[1]",
            ]
        ...
        "attachment_url": {
            "re": ["", ""],
            "xpath": ["//ul[@id='appendixList']/li//a/@href", ""]
        },  # 附件链接
        "keyword": {
            "re": ["", ""],
            "xpath": ["", ""]
    ...
    "招商局集团电子招标交易平台-采购公告": {
        ...
        "bid_finish_time": {
            "re": [''],
            "xpath": [
                'string(//th[contains(string(),"开标时间")]/following-sibling::td[1])',
            ]
        },  # 开标时
        "bid_end_time": {
            "re": [''],
        ...
        "agency": {
            "re": [''],
            "xpath": [
                '//th[contains(string(),"代理机构名称")]/following-sibling::td[1]',
                '//th[contains(string(),"代办机构名称")]/following-sibling::td[1]',
                '//th[contains(string(),"机构名称")]/following-sibling::td[1]',
            ]
        },  # 代理机
        "bid_evaluation_rule": {
            "re": ['投标人资格要求(.+?)<strong>'],
            "xpath": [
                'string(//th[contains(string(),"资格要求")]/following-sibling::td[1])'
            ]
        },  # 评标规
        "bid_winner": {
            "re": [''],
            "xpath": ['string(//td[contains(string(),"第一中标候选人")]/following-sibling::td[1])']
        },  # 中标
        "win_bid_price": {
            "re": [''],
            "xpath": ['string(//td[contains(string(),"第一中标候选人")]/following-sibling::td[2])']
        },  # 中标金
        "win_bid_announcement_time": {
            "re": [''],
            "xpath": ['']
        ...
        "attachment_url": {
            "re": [''],
            "xpath": [
                '//span[@class="title"]/a[contains(string(), "PDF")]/@href',
            ]
        },  # 附件链
        "keyword": {
            "re": [''],
    ...
    "招商局集团电子招标交易平台-项目结果公告": {
        ...
        "bid_winner": {
            "re": [''],
            "xpath": [
                '//th[contains(text(),"中标人")]/following-sibling::td[1]',
                '//td[@class="bj"][contains(text(), "供应商名称")]/../following::*/td[count(//td[@class="bj"][contains(text(), "供应商名称")]) + 1]',
                'string(//td[contains(string(),"第一中标候选人")]/following-sibling::td[1])',
                      ]
        },  # 中标
        "win_bid_price": {
            "re": [''],
            "xpath": [
                '//th[contains(text(),"中标价")]/following-sibling::td[1]',
                'string(//td[contains(string(),"第一中标候选人")]/following-sibling::td[2])',
            ]
        },  # 中标金
        "win_bid_announcement_time": {
            "re": [''],
    ...
    "中国采购网-地方单位采购公告": {
        ...
        "phone": {
            "re": [
                '项目联系方式[\s\S]*?电[\s\S]话：(.+?)</p',
                '项目联系方式[\s\S]*?电话：(.+?)</p',
                '项目联系方式[\s\S]*?联系方式：(.+?)<input',
                '电　话：(.*?)(?=<|，)',
                '项目联系电话(.*?)</tr>',
                '项目联系电话：(\d[a-zA-Z0-9\-、－—\转\(\)（）]+?)(?=<|，)',
                '负责人: (.*?) <'],
    ...
    "中国采购网-中央单位采购公告": {
        "project_title": {
            ...
            "xpath": [
                "//h2[@class='tc']",
                '//strong[contains(text(),"项目名称")]/../span',
    ...
    "国e招标采购平台-业务公告": {
        ...
        "tender_price": {
            ...
            "xpath": ["//td[contains(string(), '项目采购预算')]/../following::*[1]/td[count(//table[1]//td[contains(string(), '项目采购预算')]/preceding-sibling::td) + 1]"]
        },  # 标的金额
        "publish_time": {
            "re": [
                'LastSaved>(.+?)T',
        ...
        "attachment_url": {
            "re": [''],
            "xpath": [
                '//div[@id="online_affixLink"]/a',
                '//div[@class="details"]//a[@href]',
                '//a[contains(string(), "点击下载")]/@href',
                '//div[@id="online_affixLink"]/a[contains(string(), "附件点击可下载")]/@href',
            ]
        },  # 附件链接
        "keyword": {
            "re": [''],
    ...
    "广州国企阳光采购服务平台-采购公告": {
        ...
        "tender_unit": {
            ...
            "xpath": [
                ...
                "string(//span[contains(text(),'单位名称：')])",
        ...
        "attachment_url": {
            "re": ["", ""],
            "xpath": ["//div[@class='relevant-list']/ul/li/a/@href"]
        },
    ...
    "中国能建电子采购平台-招标公告": {
        "project_title": {
            "re": ["", ""],
            "xpath": [
                "string(//div[@id='zwPanel']/table//tr)",
                "//div[@id='zwPanel']//tbody/tr[1]",
            ]
        },
    ...
    "招采云电子招投标交易平台-招标公告": {
        ...
        "content": {
            "re": [''],
            "xpath": [
                "//div[@class='viewcon']//p|//div[@class='viewcon']//tr",
                '//div[@class="text"]',
            ]
        },  # 正文
        "bid_finish_time": {
    ...
    "招采云电子招投标交易平台-中标公告": {
        ...
        "project_number": {
            ...
            "xpath": [
                '//tr[@class="firstRow"]/td[contains(string(), "招标编号")]/following::td[1]',
        ...
        "tender_unit": {
            ...
            "xpath": [
                '//td[contains(string(), "建设单位")]/following-sibling::td[1]',
        ...
        "project_location": {
            "re": [''],
            "xpath": ['//td[contains(string(), "所属地区")]/following::td[1]']
        },  # 项目所在地
        "industry_type": {
            "re": [''],
            "xpath": ['']
        ...
        "agency": {
            ...
            "xpath": [
                '//td[contains(string(), "代理单位")]/following-sibling::td[1]',
                '//td[contains(text(),"采购代理机构全称")]',
                      '//span[contains(text(),"采购代理机构信息")]/../../following-sibling::p[1]',
                      '//span[contains(string(),"招标代理机构：")]/following-sibling::span',
                      '//span[contains(string(),"采购代理机构信息")]/following::*//span[contains(string(),"名 称：")]/following-sibling::*',
                      '//span[contains(string(),"代理：")]/following-sibling::span[1]',
        ...
        "win_bid_price": {
            ...
            "xpath": [
                "//td[contains(string(), '投标报价')]/../following::*[1]/td[count(//table[1]//td[contains(string(), '投标报价')]/preceding-sibling::td) + 1]",
                '//td[contains(string(), "中标价")]/following-sibling::td[1]',
    ...
    "中国通用招标网-招标采购公告": {
        ...
        "project_number": {
            "re": [
                '招标编号：([0-9a-zA-Z-]{1,}).*?采购人自编号',
                '招标编号：([0-9a-zA-Z-]{1,}).*?代理机构备案编号',
                '项目编号：(.+?)</span></p',
                '招标编号：(.+?)</span></p',
                '编号：(.+?)</span></p',
                '项目编号：(.+?)</span></li',
        ...
        "bid_winner": {
            ...
            "xpath": [
                '//th[string()="中标人"]/following-sibling::td[1]',
                '//td[@class="bj"][contains(text(), "供应商名称")]/../following::*/td[count(//td[@class="bj"][contains(text(), "供应商名称")]) + 1]',
                'string(//td[contains(string(),"第一中标候选人")]/following-sibling::td[1])',
                      ]
        },  # 中标人
        "win_bid_price": {
            ...
            "xpath": [
                '//th[string()="中标价"]/following-sibling::td[1]',
                'string(//td[contains(string(),"第一中标候选人")]/following-sibling::td[2])',
            ]
        },  # 中标金额
        "win_bid_announcement_time": {
