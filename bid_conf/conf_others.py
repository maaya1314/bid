...
base_dict = {
        ...
        "content": {
            "re": [''],
            "xpath": [
                "//div[@class='news-detailed']/div[@class='clearfix']",
                "//div[@class='news-detailed']/div[@class='clearfix']/div[1]/table[@class='tabList']",
                "//div[@class='news-detailed']/div[@class='clearfix']/table",  # 四川省公共资源交易信息网
        ...
        "bid_winner": {
            ...
            "xpath": [
                ...
                '//td[string()="中标单位"]/../following::*[1]/td[count(//td[string()="中标单位"]/preceding-sibling::td) + 1]',
                '//td[string()="中标供应商名称"]/../following::*[1]/td[count(//div/div[@class="news-detailed"]//td[string()="中标供应商名称"]/preceding-sibling::td) + 1]',
                '//td[string()="供应商名称"]/../following::*[1]/td[count(//div/div[@class="news-detailed"]//td[string()="供应商名称"]/preceding-sibling::td) + 1]',
                '//*[text()="成交候选人名称："]/following-sibling::*[1]',
                '//*[text()="中标人名称："]/following-sibling::*[1]',
                '//*[text()="中标人名称"]/following-sibling::*[1]',
                "//*[text()='成交人名称：']/following-sibling::*[1]",
                "//*[text()='中标单位']/following-sibling::*[1]",
                ' //*[string()="采购人"]/following::*[1]',
                "//*[string()='中标单位']/following::*[1]",
                ...
                # "//div[string()='中标单位']/ancestor::tr[2]//td[count(//div[string()='中标单位']) + 1]",
                # "//div[string()='中标单位']/ancestor::tr/following::*[1]/td[count(//div[string()='中标单位']) + 1]",
...
@Author: CZC
@File: conf_others.py
others项目，函数功能与conf_3一致，只是为了项目区分
"""
parse_dict = {
    '四川省公共资源交易信息网-工程建设-中标结果公示': base_dict,
    '四川省公共资源交易信息网-政府采购-中标公告': base_dict,
    '四川省公共资源交易信息网-国企采购-交易结果': base_dict,
    '四川省公共资源交易信息网-国有产权': base_dict,
    '四川省公共资源交易信息网-土地使用权': base_dict,
    '四川省公共资源交易信息网-矿业权': base_dict,
    '四川省公共资源交易信息网-其他类别': base_dict,
