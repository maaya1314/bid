...
base_dict1 = {
        ...
        "receive": {
            ...
            "xpath": [
                'string(//p[text()="招标文件的获取"]/following-sibling::p)'
            ]
        },  # 招标文件的领取
        "submit": {
            "re": [
            ...
            "xpath": [
                'string(//p[text()="投标文件的递交"]/following-sibling::p)',
            ]
        },  # 投标文件的递交
        "bid_scope": {
            "re": [
        ...
        "bid_condition": {
            ...
            "xpath": ['string(//p[text()="招标条件"]/following-sibling::p)']
        },  # 招标条件
...
parse_dict = {
    ...
    '华电采购平台-招标公告': base_dict1,
    '华电采购平台-中标候选人公示': base_dict1,
    '非招标公告-竞争性谈判报告': base_dict1,
    '非招标公告-询价公告': base_dict1,
    '非招标公告-单一来源公示': base_dict1,
}
